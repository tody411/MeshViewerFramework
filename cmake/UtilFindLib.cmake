...
function(UTIL_FIND_LIBRARIES target library_NAMES libraries_Var)
    ...
    foreach(_target_lib ${${library_NAMES}})
        ...
        find_library(_${_target_lib}_SEARCHED_LIBRARY ${_target_lib}
        PATHS ${${_target_LIBRARY_DIRS}}
        PATH_SUFFIXES lib
        DOC "${target}: ${_target_lib} library")

        if (${_${_target_lib}_SEARCHED_LIBRARY})
            message(STATUS "${target}: _searched_LIBRARY: ${_${_target_lib}_SEARCHED_LIBRARY}")
        endif()
        list(APPEND _libraries ${_${_target_lib}_SEARCHED_LIBRARY})
    endforeach()
